...
namespace TEServerTest
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TEServerContext>(options => 
                options.UseSqlServer(Configuration.GetConnectionString("TEServerContext")));

            services.AddIdentity<ApplicationUser, IdentityRole>(options =>
            {
                options.Password.RequiredLength = 10;
            })
            .AddEntityFrameworkStores<TEServerContext>();
